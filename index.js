...
+ 'FN:WAZR29\n' // Nama
+ 'ORG:WAZR29-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=593987326745:+593 987-326-74\n' // Nomor bot
+ 'END:VCARD' 
...
┃ _Ex : ${prefix}Ephoto 25 WAZR29_
┠⊷️ *${prefix}Textpro list*
┃ _Lista de textpro
┠⊷️ *${prefix}Textpro (code + Texto)*
┃ _Ex : ${prefix}Textpro 593 WAZR29_
┗━━━━━━━━━━━━━━━━━━━━
*〘 IMAGENES 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
...
//--Convert stiker to image
				case 'toimg':
					...
					exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'WAZR29'})
						fs.unlinkSync(ran)
					})
					break
